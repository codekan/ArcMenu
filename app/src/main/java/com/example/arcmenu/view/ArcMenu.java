...
public class ArcMenu extends ViewGroup implements View.OnClickListener {
    ...
    public static final String TAG = ArcMenu.class.getSimpleName();
    ...
    public ArcMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Log.e(TAG, "ArcMenu: position = " + mPosition + ", radius = " + mRadius);
        a.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            // 测量child 测量完所有child就有measured宽高了 ？？？？？
    ...
    public void toggleMenu(int duration) {
        ...
        for (int i = 0; i < count - 1; i++) {
            ...
            if (mCurrentStatus == Status.CLOSE) {
                tranAnim = new TranslateAnimation(xflag * cl, 0, yflag * ct, 0); // 相对位置？？？？
                childView.setClickable(true);
                childView.setFocusable(true);
            } else { // to close
                tranAnim = new TranslateAnimation(0, xflag * cl, 0, yflag * ct); // 相对位置？？？？
